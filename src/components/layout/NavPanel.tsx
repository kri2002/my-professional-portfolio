  ...
  useFrame((state) => {
    if (groupRef.current) {
      groupRef.current.rotation.y =
        Math.sin(state.clock.getElapsedTime() * 0.9) * 0.15;
    }
  });
  ...
  return (
    <div className="flex flex-col w-full lg:h-screen lg:sticky lg:top-0 pointer-events-auto relative isolate bg-[#0f172a]">
      ...
      >
        ...
        >
          <motion.h1
            ...
            className={`font-extrabold tracking-tight text-white leading-none ${
              isHero
                ? "text-3xl lg:text-6xl xl:text-8xl drop-shadow-2xl"
          ...
          <motion.h1
            ...
            className={`font-black tracking-tight leading-none text-transparent [-webkit-text-stroke:1px_#818cf8] lg:[-webkit-text-stroke:2px_#818cf8] ${
              isHero
                ? "text-3xl lg:text-6xl xl:text-8xl pb-1 lg:pb-3"
                : "text-2xl lg:text-5xl text-indigo-400 pb-1 lg:pb-2"
            }`}
          >
            Aguilar
          </motion.h1>
        ...
        <motion.h2
          ...
          className={`font-medium tracking-wide text-slate-200 mt-1 lg:mt-3 whitespace-nowrap leading-none ${
            isHero ? "text-sm lg:text-xl md:text-3xl text-center" : "text-xs lg:text-xl"
          }`}
      ...
      <motion.nav
        layout
        transition={transitionConfig}
        className={`flex z-20 pointer-events-auto lg:hidden w-full justify-center pb-16`}
      >
              ...
              <motion.li layout key={item.id} variants={navItemVariants}>
                ...
                >
                  <motion.div
                    ...
                    whileHover={{
                      width: 48,
                      backgroundColor: isActive ? "#818cf8" : "#9ca3af",
                    }}
                  />
                  <motion.span
                    className={`text-xs font-bold tracking-widest leading-none transition-colors duration-300 ${
                      isActive
                        ? "text-indigo-400"
